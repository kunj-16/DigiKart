...
const ProductForm = ({
  ...
  try {
    ...
    formData.append("upload_preset", "digikart");

    const uploadUrl = `https://api.cloudinary.com/v1_1/djj3nyamh/image/upload`;
  ...
  //       // brands and category routes are mounted at /api/v1/brands and /api/v1/category
  //       const [brandsRes, categoriesRes] = await Promise.all([
  //         Axios.get("/brands", { headers }),
